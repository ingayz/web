...
?>
    ...
    <h1 align="center">AGREGAR ARCHIVO</h1>
<form action="subir_pdf.php" method="POST" enctype="multipart/form-data">
<table align="center">
  <tr>
    <td align="center">ID</td>
    <td><input type="hidden" name="id_publicacion" value="<?php echo $id_publicacion ?>" /><?php echo $id_publicacion ?></td>
  </tr>
  <tr>
    <td></td>
    <td align="center"><input class="btn btn-lg btn-success btn-block" type="file" name="archivo" size="20" /></td>
  </tr>
  <tr>
    <td> </td>
    <td align="center"><input class="btn btn-lg btn-success btn-block" type="submit" name="archivo" value="Enviar Archivo" /></td>
  </tr>
</table>
