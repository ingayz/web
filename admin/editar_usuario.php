...
<td><div align="center"><a href="edit_usuario2.php?id_usuario=<?php echo $row['id_usuario'] ?> & nombre=<?php echo $row['nombre']; ?> & usuario=<?php echo $row['usuario']; ?> & clave=<?php echo $row['clave']; ?> & nivel=<?php echo $row['nivel']; ?>"><?php echo $row['nombre']; ?></a></div></span></td>
