...
if ($nivel == 'Administrador') {
 ...
 <h3><i class="fa icon-user-plus"></i> Modulo de Edición de Usuarios</h3>
 <div class="row mt">
 <div class="col-lg-12">
...
<br>
<form id="titulares" name="titulares" class="form-horizontal style-form" action="edit_usuario3.php" method="POST">

<input name="id_usuario" type="hidden" class="form-control round-form" id="id_usuario" value="<?php echo $id_usuario ?>">

<div class="form-group">
<label class="col-sm-4 col-sm-4 control-label">Nombre </label>
<div class="col-sm-6">
<input name="nombre" type="text" class="form-control round-form" id="nombre" value="<?php echo $nombre ?>">
</div>
</div>
...
<div class="col-sm-6">
<input name="usuario" type="text" class="form-control round-form" id="usuario" value="<?php echo $usuario ?>">
</div>
</div>
...
<div class="col-sm-6">
<input name="clave" type="text" class="form-control round-form" id="clave" value="<?php echo $clave ?>">
</div>
</div>
