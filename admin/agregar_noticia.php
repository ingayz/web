...
$sql = "INSERT INTO noticias (titulo, resumen, noticia) VALUES (:mititulo, :miresumen, :minoticia)";

$resultado=$base->prepare($sql);

$resultado->execute(array(":mititulo"=>$titulo, ":miresumen"=>$resumen, ":minoticia"=>$noticia));
...
<head>
<meta charset="utf-8">
<title>Registro de Dependencias</title>
...
//alert(edad);
 ...
 <h3><i class="fa icon-user-plus"></i> Modulo de Ingreso de Noticias</h3>
 <div class="row mt">
 <div class="col-lg-12">
...
<div class="col-sm-6">
<input name="titulo" type="text" class="form-control round-form" id="titulo">
</div>
</div>
...
<div class="col-sm-6">
<textarea name="resumen" type="text" class="form-control round-form" id="resumen" rows="7" placeholder="En 2.000 caracteres contando los signos de puntuación y espacios en blanco"></textarea>
</div>
</div>
...
<div class="col-sm-6">
<textarea name="noticia" type="text" class="form-control round-form" id="noticia" rows="15" placeholder="En 5.000 Caracteres contando los espacios y signos de puntuación"></textarea>
</div>
</div>
